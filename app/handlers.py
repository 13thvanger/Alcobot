...
<code>/add бокал вина 12%</code> — естественная форма с тарой
<code>/add 2 бокала вина 11% 25.06</code> — несколько порций
...
150 мл для вина, игристого и вермута, 50 мл для крепкого алкоголя.
Бокал пива — 500 мл, бокал вина — 150 мл, шот или стопка крепкого — 50 мл.
Явно указанная тара или объём имеют приоритет над стандартной порцией.
